"""
lgb_v2_2022.py — 2022年回测段（熊市验证）
DATA_END = 2022-12-31，留出期 = 2022 全年
"""
...
from strategies.ml.lgb_strategy_v2 import (
    ...
    LGB_PARAMS, TRAIN_YEARS, VAL_MONTHS, STEP_MONTHS,
)
...
print("=" * 64)
print(f"[2022段] DATA_END={DATA_END}")
...
config = StrategyConfig(
    name="lgb_v2_2022",
    description="LightGBM V2 回测段：2022年（熊市验证）",
    rationale=(
        "验证策略在 2022 年熊市中的表现。\n"
        f"DATA_END={DATA_END}，MODEL_CUTOFF={MODEL_CUTOFF}，留出期=2022全年。\n"
