"""
LightGBM Ensemble Adaptive Strategy V7 Style Switch
===================================================
...
python -m data.quant.strategies.lgbm_ensemble_adaptive_v7_style_switch
"""
import sys
import os
import argparse
...
class LGBMEnsembleAdaptiveV7StyleSwitch(StrategyBase):
    """
    ...
    def __init__(
        ...
        super().__init__(f"lgbm_ensemble_adaptive_v7_style_switch_{style_timing_mode}")
    ...
    def _load_style_data(self):
        ...
        index_map = {
            ...
            "csi1000": ["000852.SH.csv", "000852.SZ.csv"],
        }
...
if __name__ == "__main__":
    ...
    strategy = LGBMEnsembleAdaptiveV7StyleSwitch(
        # Model parameters
