# regime_switching Backtest Report
...
**Avg holdings**: 95 stocks / 28 industries  
...
|--------|----------|----------|----------|
| Ann. Return | +18.75% | +7.01% | +11.38% |
| Ann. Volatility | 23.55% | 16.90% | 30.33% |
| Sharpe Ratio | 0.80 | 0.41 | 0.38 |
| Max Drawdown | -21.93% | -26.04% | -39.93% |
| Cum. Return | +237.36% | +61.07% | +113.40% |
| Win Rate | 57.89% | — | — |
| Excess vs Shanghai Composite | +12.73% | — | — |
| IR vs Shanghai Composite | 0.92 | — | — |
| Excess vs CSI 500 | +2.54% | — | — |
| IR vs CSI 500 | 0.10 | — | — |
...
|------|----------|----------|--------|----------|--------|----------|
| 2019 | +18.8% | +18.0% | +0.8% | +25.1% | -6.4% | 90/28 |
| 2020 | +21.0% | +13.9% | +7.2% | -4.0% | +25.0% | 87/27 |
| 2021 | +33.8% | +4.8% | +29.0% | +4.9% | +29.0% | 88/26 |
...
- **Avg single-side turnover**: 32.4%
- **Total cost drag**: 1.66%

| Metric | Gross | Net | Diff |
|--------|-------|-----|------|
| Ann. Return | +19.03% | +18.75% | 0.28% |
| Sharpe | 0.81 | 0.80 | 0.01 |
| Cum. Return | +242.98% | +237.36% | 5.62% |
