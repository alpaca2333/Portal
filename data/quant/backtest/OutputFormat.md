...
| `benchmark` | float | 基准累计净值，初始为 1.0（无基准时省略此列） |

**示例：**

```csv
date,strategy,benchmark
2022-03-31,0.9155493,1.0065359
2022-06-30,0.9922171,0.9454975
2022-09-30,1.0341820,0.9102341
```
...
| `bench_ret` | float | ⬜ | 基准当期收益率，**小数形式**（有基准时必须提供） |
